...
% Appended to the Contacts line. Empty by default; cv-mixed.tex adds LinkedIn.
\newcommand{\contactextra}{}

% The Cashier and Momento sub-projects inside the AI Lab iOS entry. Off by
% default; cv-ios.tex switches them on. The mixed CV omits them for length,
% which is how its Overleaf original had it.
\newcommand{\ailabminorprojects}{}
...
% slip into a PDF you send out. See cv-ios.tex / cv-backend.tex / cv-mixed.tex.
